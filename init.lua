...
require('lazy').setup({
  ...
  -- various tools for Genero development
  { "harrison-dean/genero-tools.nvim",
    name = "genero-tools",
    config = function()
      require("genero-tools").setup({
        options = {
          -- auto popup define window when cursor held on word
          hover_define = true,
          hover_define_insert = true,
        },
      })
    end,
  },
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function(_, opts)
	  ...
	  -- make custom compiler script executable
	  local compiler_alias_cmd = "alias nvim-cc='~/.config/nvim/CC.sh"
	  os.execute(compiler_alias_cmd)
	  require('nvim-treesitter.install').compilers = {"nvim-cc"}
